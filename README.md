...
|---|---|---|---|---|---|
| [Kapowarr](./plugins/kapowarr) | 1.6.0 | .NET process | Connected comic library and provider libraries | No | Exact issue identities, existing-run lookup, and per-issue controls |
| [LazyLibrarian](./plugins/lazylibrarian) | 1.3.0 | .NET process | Connected Book library and existing-work management | No | Separate ebook and audiobook roots, mapped multi-part audio inventory, monitoring, and search |
