...
| [LazyLibrarian](./plugins/lazylibrarian) | 1.1.0 | .NET process | Connected Book library and existing-work management | No | Separate ebook and audiobook roots, exact catalogued-work lookup, monitoring, and search |
