...
| [LazyLibrarian](./plugins/lazylibrarian) | 1.2.0 | .NET process | Connected Book library and existing-work management | No | Separate ebook and audiobook roots, mapped multi-part audio inventory, monitoring, and search |
